...
ART1="assets/albums/i-learned-it-all-in-fifteen-seconds/art/01-i-learned-it-all-in-fifteen-seconds.jpg"
...
render_one "I Learned It All in Fifteen Seconds" \
  "assets/albums/i-learned-it-all-in-fifteen-seconds/audio/01-i-learned-it-all-in-fifteen-seconds.wav" \
...
ART2="assets/albums/i-learned-it-all-in-fifteen-seconds/art/02-second-serve.jpg"
...
render_one "Second Serve" \
  "assets/albums/i-learned-it-all-in-fifteen-seconds/audio/02-second-serve.wav" \
...
ART3="assets/albums/i-learned-it-all-in-fifteen-seconds/art/04-the-importance-of-bearing-witness.jpg"
...
render_one "The Importance of Bearing Witness" \
  "assets/albums/i-learned-it-all-in-fifteen-seconds/audio/04-the-importance-of-bearing-witness.wav" \
