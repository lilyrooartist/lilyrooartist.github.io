...
def social_platform_repair_guidance(item: dict) -> dict:
    ...
    if "tiktok" in platform:
        return {
            "repair_action": "Keep TikTok out of the active plan until direct public Content Posting API approval is explicit; upload-draft/manual-finish posting is excluded.",
...
def manual_posting_clipboard_state(packet: dict) -> dict:
    ...
    return {
        ...
        "first_post_runbook": packet.get("first_post_runbook") or {},
