...
OUTPUT = REPO_ROOT / "data" / "youtube_analog_myth_playlist.json"

PLAYLIST_TITLE = "Analog Myth - Lily Roo"
PLAYLIST_DESCRIPTION = (
    "The Lily Roo album Analog Myth, in track order. Remastered YouTube videos "
...
def wait_for_playlist_order(token: str, playlist_id: str, expected_ids: list[str]) -> list[dict]:
...
def main() -> int:
    ...
    after_items = wait_for_playlist_order(token, playlist_id, final_ids)
