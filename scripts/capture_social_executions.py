...
def summarize(payload: dict) -> dict:
    ...
    return {
        ...
        "current_executions": [safe_execution(item) for item in current_executions],
        "posted": [safe_execution(item) for item in posted],
        "draft_uploaded": [safe_execution(item) for item in draft_uploaded],
