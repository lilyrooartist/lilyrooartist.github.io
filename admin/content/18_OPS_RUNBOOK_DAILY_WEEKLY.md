...
Actions:
1. Run `python3 scripts/capture_youtube_public.py`
2. Run `python3 scripts/capture_spotify_release.py`
3. Run `python3 scripts/capture_live_metrics.py`
4. Update what is known in `data/manual_social_stats.json`
