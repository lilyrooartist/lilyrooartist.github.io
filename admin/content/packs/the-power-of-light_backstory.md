# The Power of Light (My Second Room Has No Light Switch Reprise) — Backstory Pack
...
- Link each excerpt to the original room/light-switch motif and the new "chosen light" turn.

## Social use cases
- **X:** one contrast line between the old room and the new light
- **Instagram:** cover art with a caption about carrying your own light into the same room
- **TikTok:** 15–25s hook using the light-switch visual and a dry before/after caption
- **Facebook:** longer context paragraph naming it as a reprise without over-explaining the metaphor

## Lily voice notes
- Write as Lily posting directly, not as a narrator explaining Lily.
- Keep the humor dry and a little unimpressed with the universe.
- The joke is that the solution is handmade, taped up, and still somehow profound.
- Avoid turning "light" into generic inspiration language. This is about an actual little room, an actual workaround, and a stubborn kind of agency.
