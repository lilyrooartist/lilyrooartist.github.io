...
1. Close-up album cover: torn cobalt painter's tape around a small smart-button/light-control above an old analog wall switch, warm textured plaster, handmade and slightly uncanny.
2. Before/after diptych: the old switch below, the taped-over light-control above, both treated as one improvised system.
3. Text-card visual: "The Power of Light" in stark white type over a grainy black room with one practical light source.

## Motif map
- Missing switch
- Portable glow
- Doorframe spill light
- Same room, changed agency

## Aspect targets
- TikTok/IG Reels: 1080x1920
...
## Video pan direction
- Start tight on the bottom analog light switch.
- Keep the first half mostly in the lower-switch world.
- Pan upward in the second half to reveal the taped smart-button/light-control as the final visual arrival.
