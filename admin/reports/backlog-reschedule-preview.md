...
Generated: 2026-09-14T12:51:28.733013+00:00
...
- Start at: **2026-09-15T10:00:00+00:00**
- Spacing hours: **24**
...
- **Facebook - Slow Walk** (`FP-GROWTH-RESET-01-SLOW-WALK-LYRIC-PUNCH-LINE-FACEBOOK`)
  ...
  - Proposed: `2026-09-15T10:00:00+00:00`
...
- **YouTube - Spilling the Tea** (`FP-GROWTH-RESET-06-SPILLING-THE-TEA-RELATABLE-SITUATION-YOUTUBE`)
  ...
  - Proposed: `2026-09-22T10:00:00+00:00`
  - Blocker: API request failed (400): {"error":"invalid_grant","error_description":"Token has been expired or revoked."}
  - Clearance: Clear the executor attention item in data/social_execution_snapshot.json before normal reschedule apply.
...
- **YouTube - No Mortgage** (`FP-GROWTH-RESET-12-NO-MORTGAGE-ECHO-THREAD-SETUP-SONG-PAYOFF-YOUTUBE`)
  ...
  - Proposed: `2026-09-30T10:00:00+00:00`
  - Blocker: API request failed (400): {"error":"invalid_grant","error_description":"Bad Request"}
  - Clearance: Clear the executor attention item in data/social_execution_snapshot.json before normal reschedule apply.
...
## Commands
- Preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-09-15T10:00:00+00:00' --spacing-hours 24`
- Partial clear preview: `none`
- Partial clear apply: `none`
- Safe apply: none until blockers clear
- Blocked apply command: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-09-15T10:00:00+00:00' --spacing-hours 24 --apply --refresh-admin`
- Deliberate override command: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-09-15T10:00:00+00:00' --spacing-hours 24 --allow-blocked --apply --refresh-admin`
