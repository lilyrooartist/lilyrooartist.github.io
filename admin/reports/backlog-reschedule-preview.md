...
Generated: 2026-07-31T17:01:51.530448+00:00

## Summary
- Approved backlog rows: **14**
- Rows with known blockers: **14**
- Clear to apply without override: **0**
- Manual handoff rows excluded from auto-reschedule: **0**
- Start at: **2026-08-01T10:00:00+00:00**
- Spacing hours: **24**
...
- **Facebook - Slow Walk** (`FP-GROWTH-RESET-01-SLOW-WALK-LYRIC-PUNCH-LINE-FACEBOOK`)
  ...
  - Proposed: `2026-08-01T10:00:00+00:00`
...
- **YouTube - Spilling the Tea** (`FP-GROWTH-RESET-06-SPILLING-THE-TEA-RELATABLE-SITUATION-YOUTUBE`)
  ...
  - Proposed: `2026-08-08T10:00:00+00:00`
  - Blocker: API request failed (400): {"error":"invalid_grant","error_description":"Token has been expired or revoked."}
  - Clearance: Clear the executor attention item in data/social_execution_snapshot.json before normal reschedule apply.
...
## Commands
- Preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-08-01T10:00:00+00:00' --spacing-hours 24`
- Partial clear preview: `none`
- Partial clear apply: `none`
- Safe apply: none until blockers clear
- Blocked apply command: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-08-01T10:00:00+00:00' --spacing-hours 24 --apply --refresh-admin`
- Deliberate override command: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-08-01T10:00:00+00:00' --spacing-hours 24 --allow-blocked --apply --refresh-admin`
