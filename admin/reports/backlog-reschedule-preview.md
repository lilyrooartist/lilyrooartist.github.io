...
Generated: 2026-08-01T03:51:54.833720+00:00
...
- Start at: **2026-08-02T10:00:00+00:00**
- Spacing hours: **24**
...
- **YouTube - No Mortgage** (`FP-GROWTH-RESET-10-NO-MORTGAGE-RELATABLE-SITUATION-YOUTUBE`)
  ...
  - Proposed: `2026-08-15T10:00:00+00:00`
  - Blocker: API request failed (400): {"error":"invalid_grant","error_description":"Token has been expired or revoked."}
  - Clearance: Clear the executor attention item in data/social_execution_snapshot.json before normal reschedule apply.
...
## Commands
- Preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-08-02T10:00:00+00:00' --spacing-hours 24`
- Partial clear preview: `none`
- Partial clear apply: `none`
- Safe apply: none until blockers clear
- Blocked apply command: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-08-02T10:00:00+00:00' --spacing-hours 24 --apply --refresh-admin`
- Deliberate override command: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-08-02T10:00:00+00:00' --spacing-hours 24 --allow-blocked --apply --refresh-admin`
