...
- **TikTok - I Learned It All in Fifteen Seconds** (`FP-AUTO-264`)
  ...
  - Proposed: `2026-06-18T10:00:00+00:00`
...
- **Facebook - I Learned It All in Fifteen Seconds** (`FP-AUTO-265`)
  ...
  - Proposed: `2026-06-19T10:00:00+00:00`
  - Blocker: Facebook blocked Page publishing until identity is confirmed in the Facebook app.

## Commands
- Preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --start-at '2026-06-17T10:00:00+00:00' --spacing-hours 24`
- Apply after blockers are cleared: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --start-at '2026-06-17T10:00:00+00:00' --spacing-hours 24 --apply --refresh-admin`
