...
- **Instagram - I Learned It All in Fifteen Seconds** (`FP-AUTO-263`)
  ...
  - Proposed: `2026-06-14T10:00:00-04:00`
...
- **TikTok - I Learned It All in Fifteen Seconds** (`FP-AUTO-264`)
  ...
  - Proposed: `2026-06-15T10:00:00-04:00`
...
- **Facebook - I Learned It All in Fifteen Seconds** (`FP-AUTO-265`)
  ...
  - Proposed: `2026-06-16T10:00:00-04:00`
  - Blocker: Facebook blocked Page publishing until identity is confirmed in the Facebook app.

## Commands
- Preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --start-at '2026-06-14T10:00:00-04:00' --spacing-hours 24`
- Apply after blockers are cleared: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --start-at '2026-06-14T10:00:00-04:00' --spacing-hours 24 --apply --refresh-admin`
