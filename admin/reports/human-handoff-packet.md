...
Generated: 2026-07-30T03:31:10.199787Z

## Summary
- Open handoff tasks: **17**
- Tod-owned tasks: **16**
- External/platform-gated tasks: **1**
- High urgency tasks: **15**
- Low urgency tasks: **2**
...
- Resolution worksheet: `data/human_handoff_resolution_worksheet.csv` (17 row(s))
...
- **Repair blocked platform executor setup** (`blocked`)
  - Owner: `tod`; tasks: **14**; blockers resolved: **14**
...
- **Reschedule approved backlog after blockers clear** (`blocked`)
  - Owner: `external_platform`; tasks: **1**; blockers resolved: **13**
  ...
  - Sequence preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-07-31T10:00:00+00:00' --spacing-hours 24`
  - Sequence verify: `python3 scripts/refresh_promo_admin.py`
