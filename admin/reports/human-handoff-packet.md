...
Generated: 2026-07-25T03:39:35.252497Z

## Summary
- Open handoff tasks: **13**
- Tod-owned tasks: **12**
- External/platform-gated tasks: **1**
- High urgency tasks: **11**
- Low urgency tasks: **2**
...
- Resolution worksheet: `data/human_handoff_resolution_worksheet.csv` (13 row(s))
...
- **Repair blocked platform executor setup** (`blocked`)
  - Owner: `tod`; tasks: **10**; blockers resolved: **10**
...
- **Reschedule approved backlog after blockers clear** (`blocked`)
  - Owner: `external_platform`; tasks: **1**; blockers resolved: **9**
  ...
  - Sequence preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-07-26T10:00:00+00:00' --spacing-hours 24`
  - Sequence verify: `python3 scripts/refresh_promo_admin.py`
