...
Generated: 2026-09-05T20:24:52.207615Z

## Summary
- Open handoff tasks: **20**
- Tod-owned tasks: **19**
- External/platform-gated tasks: **1**
- High urgency tasks: **18**
- Low urgency tasks: **2**
...
- Resolution worksheet: `data/human_handoff_resolution_worksheet.csv` (20 row(s))
...
- **Repair blocked platform executor setup** (`blocked`)
  - Owner: `tod`; tasks: **17**; blockers resolved: **17**
...
- **Reschedule approved backlog after blockers clear** (`blocked`)
  - Owner: `external_platform`; tasks: **1**; blockers resolved: **16**
  ...
  - Sequence preview: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-09-06T10:00:00+00:00' --spacing-hours 24`
  - Sequence verify: `python3 scripts/refresh_promo_admin.py`
...
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-04-SLOW-WALK-ECHO-THREAD-SETUP-SONG-PAYOFF-YOUTUBE`)
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair Facebook executor** (`platform-setup-FP-GROWTH-RESET-05-SPILLING-THE-TEA-LYRIC-PUNCH-LINE-FACEBOOK`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Open the Facebook app as the Page admin and complete the identity confirmation prompt, then run a worker dry-run check.
...
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-05-SPILLING-THE-TEA-LYRIC-PUNCH-LINE-YOUTUBE`)
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair Facebook executor** (`platform-setup-FP-GROWTH-RESET-06-SPILLING-THE-TEA-RELATABLE-SITUATION-FACEBOOK`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Open the Facebook app as the Page admin and complete the identity confirmation prompt, then run a worker dry-run check.
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-06-SPILLING-THE-TEA-RELATABLE-SITUATION-YOUTUBE`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Review platform credentials/readiness, then rerun the social execution capture.
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair Facebook executor** (`platform-setup-FP-GROWTH-RESET-07-SPILLING-THE-TEA-VISUAL-STORY-FACEBOOK`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Open the Facebook app as the Page admin and complete the identity confirmation prompt, then run a worker dry-run check.
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-07-SPILLING-THE-TEA-VISUAL-STORY-YOUTUBE`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Review platform credentials/readiness, then rerun the social execution capture.
...
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-09-NO-MORTGAGE-LYRIC-PUNCH-LINE-YOUTUBE`)
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-10-NO-MORTGAGE-RELATABLE-SITUATION-YOUTUBE`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Review platform credentials/readiness, then rerun the social execution capture.
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-11-NO-MORTGAGE-VISUAL-STORY-YOUTUBE`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Review platform credentials/readiness, then rerun the social execution capture.
  ...
  - Guardrail: Push worker secrets only after local platform setup is complete.
- **Repair YouTube executor** (`platform-setup-FP-GROWTH-RESET-12-NO-MORTGAGE-ECHO-THREAD-SETUP-SONG-PAYOFF-YOUTUBE`)
  - Phase: `Platform setup`; owner: `tod`; status: `failed`; urgency: `high`
  - Detail: Review platform credentials/readiness, then rerun the social execution capture.
