...
Generated: 2026-07-23T14:33:58.862256Z

## Summary
- Open handoff tasks: **12**
- Tod-owned tasks: **11**
- External/platform-gated tasks: **1**
- High urgency tasks: **10**
- Low urgency tasks: **2**
...
- Resolution worksheet: `data/human_handoff_resolution_worksheet.csv` (12 row(s))
...
- **Repair blocked platform executor setup** (`blocked`)
  - Owner: `tod`; tasks: **9**; blockers resolved: **9**
...
- **Reschedule approved backlog after blockers clear** (`blocked`)
  - Owner: `external_platform`; tasks: **1**; blockers resolved: **8**
