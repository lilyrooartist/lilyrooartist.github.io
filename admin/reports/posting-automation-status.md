...
Generated: 2026-08-07T19:21:33.995580Z
...
- **Scheduled refresh workflow** - `needs_attention`
  ...
  - Evidence: https://github.com/lilyrooartist/lilyrooartist.github.io/actions/runs/31210781211
...
- **Published URL export** - `needs_attention`
  - Detail: safe refresh runs python3 scripts/export_social_executions.py; latest export added=1 dry_run=False; next proof refresh=2026-08-07T18:20:00Z
...
- **Safe admin refresh** - `ready`
  - Detail: 19 refresh commands captured at 2026-08-07T19:21:31.777716Z
  - Evidence: data/promo_admin_refresh_run.json
...
- **Execution capture** - `ready`
  - Detail: posted=62 attention=16 platform_fix_needed=16
