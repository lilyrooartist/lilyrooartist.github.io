...
Generated: 2026-09-03T19:10:16.409931Z
...
- **Active Analog Myth brand campaign** - `needs_attention`
  - Detail: 48 approved auto posts; next=none at n/a; preflight=needs_attention
  - Evidence: data/brand_growth_preflight.json
  - Next: no future campaign window
- **Scheduled refresh workflow** - `ready`
  ...
  - Evidence: https://github.com/lilyrooartist/lilyrooartist.github.io/actions/runs/33794734803
- **Published URL export** - `needs_attention`
  - Detail: safe refresh runs python3 scripts/export_social_executions.py; latest export added=unknown dry_run=unknown; next proof refresh=2026-07-13T18:20:00Z
...
- **Safe admin refresh** - `ready`
  - Detail: 19 refresh commands captured at 2026-09-03T19:10:14.138572Z
  - Evidence: data/promo_admin_refresh_run.json
