...
Generated: 2026-09-04T20:47:22.081926Z
...
- **Scheduled refresh workflow** - `needs_attention`
  - Detail: 17 */6 * * *, 25 15 * * *, 05 16 * * *, 20 18 * * *; latest run queued / pending; proof refresh next fixed refresh 14 minute(s) after proof due
  - Evidence: https://github.com/lilyrooartist/lilyrooartist.github.io/actions/runs/33917956016
...
- **Safe admin refresh** - `ready`
  - Detail: 19 refresh commands captured at 2026-09-04T20:47:19.900866Z
  - Evidence: data/promo_admin_refresh_run.json
