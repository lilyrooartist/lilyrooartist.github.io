...
Generated: 2026-07-20T19:58:12.813695Z
...
- **Scheduled refresh workflow** - `needs_attention`
  ...
  - Evidence: https://github.com/lilyrooartist/lilyrooartist.github.io/actions/runs/29774131849
...
- **Published URL export** - `needs_attention`
  - Detail: safe refresh runs python3 scripts/export_social_executions.py; latest export added=1 dry_run=False; next proof refresh=2026-07-20T18:20:00Z
...
- **Safe admin refresh** - `ready`
  - Detail: 19 refresh commands captured at 2026-07-20T19:58:10.582451Z
  - Evidence: data/promo_admin_refresh_run.json
...
- **Execution capture** - `ready`
  - Detail: posted=52 attention=5 platform_fix_needed=5
