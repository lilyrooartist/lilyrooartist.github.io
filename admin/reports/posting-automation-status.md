...
Generated: 2026-08-04T17:15:14.729852Z
...
- Help-needed items: **0**
- Proof refresh: **ready** at `2026-08-04T15:25:00Z` (4 min)
...
- **Active Analog Myth brand campaign** - `needs_attention`
  - Detail: 48 approved auto posts; next=FP-GROWTH-RESET-12-NO-MORTGAGE-ECHO-THREAD-SETUP-SONG-PAYOFF-FACEBOOK at 2026-08-04T11:20:00-04:00; preflight=needs_attention
...
- **Scheduled refresh workflow** - `ready`
  ...
  - Evidence: https://github.com/lilyrooartist/lilyrooartist.github.io/actions/runs/30932666541
- **Published URL export** - `needs_attention`
  - Detail: safe refresh runs python3 scripts/export_social_executions.py; latest export added=1 dry_run=False; next proof refresh=2026-08-04T15:25:00Z
...
- **Safe admin refresh** - `ready`
  - Detail: 19 refresh commands captured at 2026-08-04T17:15:12.462508Z
  - Evidence: data/promo_admin_refresh_run.json
- **Scheduler dry-run authentication** - `ready`
  - Detail: HTTP 200 using bearer auth; due=17 would_post=0
  - Evidence: data/social_scheduler_dry_run.json
- **Execution capture** - `ready`
  - Detail: posted=61 attention=16 platform_fix_needed=16
