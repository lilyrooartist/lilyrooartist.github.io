...
Generated: 2026-07-23T14:33:59.576618Z
...
- **Scheduled refresh workflow** - `ready`
  ...
  - Evidence: https://github.com/lilyrooartist/lilyrooartist.github.io/actions/runs/30016354990
...
- **Safe admin refresh** - `ready`
  - Detail: 19 refresh commands captured at 2026-07-23T14:33:57.400268Z
  - Evidence: data/promo_admin_refresh_run.json
- **Scheduler dry-run authentication** - `ready`
  - Detail: HTTP 200 using bearer auth; due=8 would_post=1
  - Evidence: data/social_scheduler_dry_run.json
- **Execution capture** - `ready`
  - Detail: posted=52 attention=8 platform_fix_needed=8
