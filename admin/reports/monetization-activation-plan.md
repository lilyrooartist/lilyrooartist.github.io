...
Generated: 2026-07-02T11:53:10.713499Z
...
1. **Preview approved backlog reschedule**
   ...
   - After review: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-07-03T10:00:00-04:00' --spacing-hours 24 --apply --refresh-admin`
...
5. **Current operations next action: Preview clear approved backlog row**
   ...
   - Preview/check: `python3 scripts/reschedule_scheduled_posts.py --id FP-WIN-ANALOG-MYTH-X-RELEASE-ART-IMAGE-STORY-HOOK --start-at '2026-07-03T10:00:00-04:00' --spacing-hours 24`
   - After review: `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-07-03T10:00:00-04:00' --spacing-hours 24 --apply --refresh-admin`
