...
Generated: 2026-07-07T22:24:11.919010Z
...
- **[high] Watch active Analog Myth proof window**
  ...
  - Detail: After 2026-07-08T15:21:00Z, capture executor proof for FP-BRAND-AM-05-NO-MORTGAGE-X, FP-BRAND-AM-05-NO-MORTGAGE-FACEBOOK and export confirmed URLs.
...
- **[high] Review brand-post visibility**
  - Why: 1 recent Analog Myth Facebook post URL(s) need public visibility review.
  - Detail: Recent Analog Myth post URLs need public visibility review.
...
- **[high] Connect automated brand metrics capture**
  - Why: 6 fresh Analog Myth post(s) are ready to measure once X/Meta metric credentials are connected.
...
- **[medium] Re-check Twelve Dollars on Spotify**
  ...
  - Detail: Searches public web results for Spotify album URLs, then validates exact-title candidates with Spotify oEmbed. Latest snapshot found no public URL; next recommended re-check after 2026-07-08T22:23:50.916425+00:00. Status: waiting_for_release_propagation.
  - Latest snapshot checked: `2026-07-07T22:23:50.916425+00:00`
...
- **[medium] Re-check Twelve Dollars on Apple Music**
  - Why: Public store links should be checked until DistroKid exposes them.
  - Detail: Uses the public iTunes Search API; if it finds the release, copy release_url into data/distrokid_release_status.json. Latest snapshot found no public URL; next recommended re-check after 2026-07-08T22:23:52.419556+00:00. Status: waiting_for_release_propagation.
  - Latest snapshot checked: `2026-07-07T22:23:52.419556+00:00`
...
- **[medium] Re-check Twelve Dollars on HyperFollow**
  - Why: Public store links should be checked until DistroKid exposes them.
  - Detail: Captures the public HyperFollow store buttons; confirm the guessed URL if DistroKid used a different slug. Latest snapshot found no public URL; next recommended re-check after 2026-07-08T22:23:52.812818+00:00. Status: waiting_for_release_propagation.
  - Latest snapshot checked: `2026-07-07T22:23:52.812818+00:00`
...
- **[medium] Re-check Analog Myth on YouTube Music**
  ...
  - Detail: Searches public web results for YouTube Music watch URLs, then validates the public title. Latest snapshot found no public URL; next recommended re-check after 2026-07-08T22:23:52.867009+00:00. Status: waiting_for_release_propagation.
  - Latest snapshot checked: `2026-07-07T22:23:52.867009+00:00`
