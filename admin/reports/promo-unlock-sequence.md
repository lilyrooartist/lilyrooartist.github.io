...
4. **Reschedule approved past-due backlog** - `unlock-backlog-reschedule`
   ...
   - preview (preview-safe): `python3 scripts/reschedule_scheduled_posts.py --approved-backlog --exclude-manual-handoff --start-at '2026-07-20T10:00:00+00:00' --spacing-hours 24`
